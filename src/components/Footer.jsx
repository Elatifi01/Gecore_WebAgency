        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 py-12 sm:py-16">
          ...
          <div className="space-y-4 text-center sm:text-left sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex justify-center sm:justify-start space-x-4">
              <a
                href="https://www.facebook.com/share/1B98ZqNUF7/?ref=share"
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-start">
                <svg
                  className="w-5 h-5 mr-2 mt-1 text-primary-green"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <li className="flex items-center">
                <svg
                  className="w-5 h-5 mr-2 text-primary-green"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
